...
export const metadata: Metadata = {
  ...
  description:
    "Olyxee is a research and infrastructure company helping businesses adapt to AI. We study the challenges organisations face when adopting AI, then build the infrastructure required to turn advanced intelligence into reliable organisational capability. Orgni, our core platform, is the operational intelligence layer that helps businesses keep work moving.",
  keywords: [
    "Olyxee",
