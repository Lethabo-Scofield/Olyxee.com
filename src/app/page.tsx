              ...
              >
                <div className="absolute inset-0">
                  <video
                    ...
                    aria-hidden="true"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-black/25 group-hover:from-black/75 group-hover:via-black/45 group-hover:to-black/20 transition-colors duration-300" />
                </div>
