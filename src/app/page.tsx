...
const STORIES = [
  {
    ...
    alt: "FreightShift homepage showing the Shanghai to OR Tambo live shipping route",
  ...
  },
  {
    ...
    alt: "Layered diagram of automated financial operations and compliance flow",
  ...
  },
  {
    ...
    alt: "Absentify product showing a Microsoft Teams call grid with team scheduling",
