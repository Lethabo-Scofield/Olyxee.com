...
export const roles: Role[] = [
  ...
  // ─── LEADERSHIP ───────────────────────────────────────────────────────
  {
    ...
    type: "paid",
    description:
      "Run the company day to day. Turn strategy into execution across operations, finance, people, and delivery so every team moves fast and ships.",
    level: "Executive · 12+ years, including operating leadership at scale",
    compensation: "Executive salary, significant equity, performance bonus, full benefits.",
    responsibilities: [
      "Own company-wide operations: planning, finance, people, legal, and delivery",
      "Turn the founder's strategy into operating plans, targets, and accountability",
      "Build the rhythms, metrics, and systems the company runs on as it scales",
      "Partner with the founder on hiring, fundraising, and major commercial decisions",
      "Lead and grow functional leaders across the business",
    ],
    requirements: [
      "12+ years of experience with significant operating leadership, ideally at a high-growth or technology company",
      "Track record scaling a company through real growth, with P&L or full operating ownership",
      "Deep fluency across finance, people, and operations, with the judgment to prioritize",
      "Experience building and leading senior teams, not just individual functions",
      "Exceptional written and verbal communication; you bring clarity under pressure",
      "MBA or equivalent operating track record is a plus, not a requirement",
    ],
    questions: PAID_QUESTIONS,
    process: PAID_PROCESS,
  },
  {
    ...
    type: "paid",
    description:
      "Own engineering across Olyxee. Set technical direction, build the team, and ship reliable products across Ordo, Addup, and Cortex.",
    level: "Executive · 10+ years engineering, with leadership at scale",
    compensation: "Executive salary, significant equity, performance bonus, full benefits.",
    responsibilities: [
      "Own engineering strategy, architecture, and delivery across all products",
      "Build, lead, and grow the engineering organization and its managers",
      "Set the bar for quality, velocity, reliability, and security",
      "Partner with research and product to turn the roadmap into shipped software",
      "Own engineering hiring, planning, and the technical culture of the company",
    ],
    requirements: [
      "10+ years building software, with 4+ years leading and growing engineering teams",
      "Track record shipping and operating complex systems at production scale",
      "Deep technical credibility; engineers trust your judgment on hard calls",
      "Experience hiring senior engineers and building engineering managers",
      "Relevant cloud or systems certifications are a plus (AWS/GCP Professional, CKA)",
      "Exceptional written communication; you set direction in writing",
    ],
    questions: PAID_QUESTIONS,
    process: PAID_PROCESS,
  },
  {
    ...
    type: "paid",
    description:
      "Lead Olyxee Research. Set the agenda on verification, evaluation, and reliability, and turn it into capability the company ships.",
    level: "Executive · PhD plus 10+ years of research leadership",
    compensation: "Executive salary, significant equity, performance bonus, full benefits.",
    responsibilities: [
      "Set and own the company-wide research agenda and its priorities",
      "Build and lead the research team and its collaborations",
      "Translate research into product capability with engineering and product",
      "Represent Olyxee in the research community through papers, talks, and partnerships",
      "Own research hiring and the standards for rigor and reproducibility",
    ],
    requirements: [
      "PhD in CS, ML, or a closely related field, plus 10+ years of research experience",
      "Strong first-author record at top venues (NeurIPS, ICML, ICLR, ACL) with a public Google Scholar profile",
      "Experience leading research teams and setting a multi-year agenda",
      "Demonstrable citation impact and work the field builds on",
      "Track record moving research into real, shipped product",
      "Exceptional written communication for technical and non-technical audiences",
    ],
    questions: PAID_QUESTIONS,
    process: PAID_PROCESS,
  },
  {
    ...
    type: "paid",
    description:
      "Own product across Olyxee. Set strategy, shape the roadmap, and build the product team behind Ordo, Addup, and Cortex.",
    level: "Executive · 10+ years product, with leadership experience",
    compensation: "Executive salary, significant equity, performance bonus, full benefits.",
    responsibilities: [
      "Own product strategy, roadmap, and outcomes across the company",
      "Build, lead, and grow the product and design organization",
      "Set the metrics that define success and own the results against them",
      "Partner with engineering, research, and go-to-market on what to build and why",
      "Drive discovery, pricing, and positioning across the portfolio",
    ],
    requirements: [
      "10+ years in product management, with 3+ years leading product teams",
      "Track record owning products that moved real business and customer outcomes",
      "Strong technical fluency; you can go deep with engineers and research",
      "Experience hiring and developing product managers",
      "Exceptional written communication; your strategy docs end debates",
      "Proven judgment on what to build, what to cut, and when to ship",
    ],
    questions: PAID_QUESTIONS,
    process: PAID_PROCESS,
  },
  {
    ...
    type: "paid",
    description:
      "Own how the world understands Olyxee. Set positioning and narrative, run launches, and build the marketing function from the ground up.",
    level: "Executive · 10+ years marketing, with leadership experience",
    compensation: "Executive salary, significant equity, performance bonus, full benefits.",
    responsibilities: [
      "Own positioning, narrative, and brand across every surface",
      "Build, lead, and grow the marketing team and its programs",
      "Drive launches, content, demand, and brand with measurable impact",
      "Own pipeline and brand outcomes alongside go-to-market and product",
      "Set the marketing strategy and the metrics it is measured on",
    ],
    requirements: [
      "10+ years marketing technical or B2B products, with 3+ years leading teams",
      "A portfolio of launches and programs you owned with measurable pipeline impact",
      "Proven ownership of both brand and demand, defensible in numbers",
      "Experience building and leading a marketing organization",
      "Exceptional writer and operator who can run many workstreams at once",
      "Calm, decisive judgment in a fast-moving company",
    ],
    questions: PAID_QUESTIONS,
    process: PAID_PROCESS,
  },
  {
    ...
    type: "paid",
    description:
      "Own revenue at Olyxee. Build the sales motion, close foundational enterprise customers, and grow the team behind it.",
    level: "Executive · 10+ years sales, with leadership experience",
    compensation: "Executive salary, significant equity, performance bonus, full benefits.",
    responsibilities: [
      "Own the full sales motion, from pipeline through close, for enterprise accounts",
      "Build, lead, and grow the sales team and its process",
      "Close foundational customers and set the playbook others run",
      "Partner with product and solutions to deliver on what we promise",
      "Own revenue targets, forecasting, and the metrics behind them",
    ],
    requirements: [
      "10+ years in B2B or enterprise sales, with 3+ years leading sales teams",
      "Track record closing enterprise deals and building repeatable sales motions",
      "Deep fluency selling technical products to executive and technical buyers",
      "Experience hiring, ramping, and developing sales talent",
      "Exceptional discovery, written, and presentation skills",
      "Calm, decisive judgment and a bias toward action",
    ],
    questions: PAID_QUESTIONS,
    process: PAID_PROCESS,
  },
