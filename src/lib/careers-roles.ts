...
export const roles: Role[] = [
  ...
  },
  {
    ...
    type: "paid",
    description:
      "Design, build, and own the product surfaces and backend services across Orgni Workflows, Orgni Finance, and Olyxee Document Integrity. Set the engineering bar.",
  ...
  },
  {
    ...
    type: "paid",
    description:
      "Own the models behind Orgni Workflows, Orgni Finance, and Olyxee Document Integrity end to end: training, evaluation, and reliable serving at production scale.",
  ...
  // ─── INTERNSHIPS (all unpaid) ─────────────────────────────────────────
  {
    ...
    type: "internship",
    description:
      "Build product surfaces and backend services across Orgni Workflows, Orgni Finance, and Olyxee Document Integrity alongside senior engineers.",
    responsibilities: [
  ...
  },
  {
    ...
    type: "internship",
    description:
      "Build AI features end to end across Orgni Workflows, Orgni Finance, and Olyxee Document Integrity, from prompt and model integration through reliable product surfaces.",
    responsibilities: [
  ...
  },
  {
    ...
    type: "internship",
    description:
      "Work alongside our team on the models that power Orgni Workflows, Orgni Finance, and Olyxee Document Integrity.",
    responsibilities: [
  ...
  },
  {
    ...
    type: "internship",
    description:
      "Help build the data pipelines that feed Orgni Finance, Olyxee Document Integrity, and our evaluation systems.",
    responsibilities: [
  ...
  },
  {
    ...
    responsibilities: [
      "Help build evaluation suites and golden datasets across Orgni Workflows, Orgni Finance, and Olyxee Document Integrity",
  ...
  },
  {
    ...
    type: "internship",
    description:
      "Support a product surface across Orgni Workflows, Orgni Finance, Olyxee Document Integrity, or Order Loop.",
    responsibilities: [
  ...
  },
  {
    ...
    type: "internship",
    description:
      "Work with enterprise customers to help deploy Orgni Workflows, Orgni Finance, and Olyxee Document Integrity into their operations.",
    responsibilities: [
