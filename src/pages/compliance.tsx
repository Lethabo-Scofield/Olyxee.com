...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: "A Data Processing Agreement (DPA) is available for customers acting as data controllers. Our DPA incorporates the EU SCCs and addresses obligations under GDPR, UK GDPR, and other applicable laws. Contact info@olyxee.com to request the current DPA."
  },
  {
  ...
  {
    title: "9. Contact",
    content: "For compliance inquiries, including DPAs, security reviews, and audit support, contact info@olyxee.com."
  },
];
