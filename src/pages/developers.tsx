        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-200 rounded-2xl overflow-hidden border border-neutral-200">
            {[
              ...
              { icon: Package, title: "API", description: "RESTful API for programmatic access to the Orgni Workflows execution engine.", status: "Beta" },
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-0 divide-y divide-neutral-200 max-w-3xl">
            {[
              ...
              { step: "04", title: "Execute", description: "Run your workflow with a single command. Orgni Workflows handles the rest." },
            ].map((item, idx) => (
