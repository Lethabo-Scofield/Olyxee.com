...
const Technology: FC = () => {
  return (
    <div className="min-h-screen bg-white text-neutral-900 relative">
      <SEO title="Technology" description="The architecture powering Olyxee's Orgni Workflows platform. Learn about our AI execution engine, goal-to-task pipeline, and operational infrastructure." path="/technology" />
      <div className="grain" />
      <Header />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div
              ...
              style={{
                backgroundImage: 'url("/images/Product_wallpaper.jpg")',
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.5 }} className="text-lg text-neutral-500 leading-relaxed max-w-3xl font-light">
            Built on Orgni Workflows, our AI execution engine. It turns business goals into completed work,
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp} className="mb-20">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl tracking-tight mb-4">
              Orgni Workflows <em className="text-neutral-500">Architecture</em>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden">
            {[
              { icon: Shield, title: "Goal Interpretation", description: "Describe what needs to be done. Orgni Workflows breaks down business goals into structured, executable task plans automatically." },
      ...
      <section className="py-28 sm:py-36 border-t border-neutral-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="divide-y divide-neutral-200 max-w-3xl">
            {[
              { step: "01", title: "Goal Input", description: "Describe the business outcome you need. Orgni Workflows interprets the goal and identifies the systems, data, and steps required.", icon: GitBranch },
              { step: "02", title: "Planning", description: "Orgni Workflows creates a structured execution plan, mapping each step to the right tools and data sources.", icon: Shield },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
            <h2 className="font-serif text-4xl sm:text-5xl tracking-tight text-neutral-900 mb-6">
              Get started <em className="text-neutral-400">with Orgni Workflows</em>
            </h2>
