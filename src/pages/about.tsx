        ...
        <section className="relative py-24 sm:py-36 bg-neutral-50/60 border-t border-neutral-200/70">
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <motion.div
              ...
              className="mt-16 sm:mt-24 pt-10 border-t border-neutral-200"
            >
              ...
              <ol className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-12">
                {TIMELINE.map((item, i) => (
                  <li key={item.year} className="relative pl-6 sm:pl-0 sm:pt-6 sm:border-t border-neutral-200">
                    <span
                      aria-hidden
                      className="absolute left-0 top-1.5 sm:top-0 sm:left-0 sm:-translate-y-1/2 w-1.5 h-1.5 rounded-full bg-neutral-400"
                    />
                    <p className="text-2xl sm:text-3xl text-neutral-900 tracking-[-0.02em] leading-none mb-2 font-medium">
                      {item.year}
                    </p>
                    <p className="text-sm text-neutral-500 font-light leading-snug max-w-xs">
                      {item.label}
                    </p>
                    <span className="absolute right-0 top-0 hidden sm:block text-[10px] font-mono uppercase tracking-[0.22em] text-neutral-400 pt-6">
