    ...
    <div className="min-h-screen bg-white text-neutral-900 relative">
      ...
      <section className="pt-32 sm:pt-44 pb-28 sm:pb-36 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }} className="font-serif text-4xl sm:text-6xl text-neutral-900 tracking-tight leading-[1.05] mb-6">
            Coming <em className="text-neutral-400">soon</em>
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="text-xl text-neutral-500 leading-relaxed max-w-2xl mx-auto font-normal mb-10">
