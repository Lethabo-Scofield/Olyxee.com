  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 relative">
      ...
      <section className="py-24 sm:py-32 bg-neutral-950 text-white relative overflow-hidden">
        <div className="absolute top-0 left-1/2 w-[600px] h-[600px] -translate-x-1/2 -translate-y-1/3 bg-blue-500/20 rounded-full blur-[120px]" />
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center relative">
          <h2 className="font-serif text-3xl sm:text-5xl tracking-tight mb-6">Ready to put logistics on autopilot?</h2>
          <p className="text-neutral-400 text-lg font-light mb-10">Talk to our team about a pilot tailored to your network.</p>
